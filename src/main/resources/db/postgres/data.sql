...
INSERT INTO owners (first_name, last_name, address, city, telephone) SELECT 'ajay', 'saran', '3/68 vellore.', 'vellore', '9989366373' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=11);
